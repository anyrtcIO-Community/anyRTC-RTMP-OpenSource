...
public class WebRtcAudioTrack {
  ...
  private static int getDefaultUsageAttribute() {
    if (Build.VERSION.SDK_INT >= 21) {
      return isVoiceMode ?AudioAttributes.USAGE_VOICE_COMMUNICATION:AudioAttributes.USAGE_MEDIA;
    } else {
  ...
  private int getStreamMaxVolume() {
    ...
    return audioManager.getStreamMaxVolume(isVoiceMode ?AudioManager.STREAM_VOICE_CALL:AudioManager.STREAM_MUSIC);
  }
  ...
  private boolean setStreamVolume(int volume) {
    ...
    audioManager.setStreamVolume(isVoiceMode ?AudioManager.STREAM_VOICE_CALL:AudioManager.STREAM_MUSIC, volume, 0);
    return true;
  }
  ...
  private int getStreamVolume() {
    ...
    assertTrue(audioManager != null);
    return audioManager.getStreamVolume(isVoiceMode ?AudioManager.STREAM_VOICE_CALL:AudioManager.STREAM_MUSIC);
  }
  ...
  private static AudioTrack createAudioTrackOnLollipopOrHigher(
    ...
    final int nativeOutputSampleRate =
        AudioTrack.getNativeOutputSampleRate(isVoiceMode ?AudioManager.STREAM_VOICE_CALL:AudioManager.STREAM_MUSIC);
  ...
  private static AudioTrack createAudioTrackOnLowerThanLollipop(
      int sampleRateInHz, int channelConfig, int bufferSizeInBytes) {
    return new AudioTrack(isVoiceMode ? AudioManager.STREAM_VOICE_CALL : AudioManager.STREAM_MUSIC, sampleRateInHz, channelConfig,
