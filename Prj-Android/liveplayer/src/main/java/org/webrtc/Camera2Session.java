...
class Camera2Session implements CameraSession {
  ...
  public float getCameraZoomMaxRatio() {
    if (this.mMaxZoom <= 0.0F) {
      CameraCharacteristics var1 = null;
      try {
        var1 = cameraManager.getCameraCharacteristics(cameraId);
      } catch (CameraAccessException e) {
        e.printStackTrace();
      }
      if (var1 == null) {
      ...
      mMaxZoom = (Float)var1.get(CameraCharacteristics.SCALER_AVAILABLE_MAX_DIGITAL_ZOOM);
    }
    return mMaxZoom;
  }
  ...
  public boolean isAutoFocusEnabled() {
    if (!this.isFocusSupported()) {
      ...
      if (var1 == null) {
        ...
        int var2 = var1.get(CameraCharacteristics.STATISTICS_INFO_MAX_FACE_COUNT);
        return var2 > 0;
      }
    }
  }
  ...
  public boolean isFocusSupported() {
    ...
    if (var1 == null) {
      ...
      int[] var2 = (int[])var1.get(CameraCharacteristics.CONTROL_AF_AVAILABLE_MODES);
      if (var2 != null) {
  ...
  private boolean isTorchSupported() {
    ...
    try {
      ...
      if (var1 == null) {
       ...
       return var1.get(CameraCharacteristics.FLASH_INFO_AVAILABLE);
      }
    } catch (CameraAccessException e) {
      e.printStackTrace();
    }
...
//    CameraCharacteristics var2 = null;
//    try {
//      var2 = cameraManager.getCameraCharacteristics(cameraId);
//      if (var2 == null) {
//        Logging.w("CAMERA2", "warning cameraCharacteristics is null");
//        return -1;
...
//        return -1;
//      } else {
//        Boolean var3 = (Boolean)var2.get(CameraCharacteristics.FLASH_INFO_AVAILABLE);
//        boolean var4 = var3 == null ? false : var3;
//        if (var4) {
//          if (this.mPreviewThread != null && this.mPreviewBuilder != null && this.mCaptureSession != null) {
//            synchronized(this.mCaptureSessionLock) {
//              if (this.mPreviewThread != null && this.mPreviewBuilder != null && this.mCaptureSession != null) {
//                Handler var6 = new Handler(this.mPreviewThread.getLooper());
//                if (var1) {
...
//                byte var10000;
//                try {
//                  this.mCaptureSession.setRepeatingRequest(this.mPreviewBuilder.build(), (CaptureCallback)null, var6);
//                  var10000 = 0;
